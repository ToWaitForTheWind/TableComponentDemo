<template>
    <div
        ...
        class="lq-virtual-list"
        :style="`height: ${(dataList.length > showNumber ? showNumber : dataList.length) * itemHeight}px;`"
    >
        <div
...
export default {
    ...
    mounted () {
        this.$refs[`listContainer${this.randomNum}`].addEventListener('scroll', this.scrollEvent);
    },
    beforeDestroyed () {
